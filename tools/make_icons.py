...
Two things, and in this order:
  ...
  * it is the nightly one.  Every icon here is in the channel's purple and
    ...
    The moon is stamped ON TOP of the drawing, in front of it, and the drawing
    is not moved out of its way.  These grids used to be squeezed into the
    part of the square the crescent does not reach -- the handhelds sat in the
    bottom two thirds and the bench was pushed left of x=20 -- which made three
    small pictures in a large empty square rather than three icons.  A badge
    that overlaps what it is badging is what a badge is.
...
GEN1_WILD_UI_NIGHTLY = (
    ...
    "..kPpkeeeeeeeeeeeeeeeeeeeekpPk..",
    "..kPpkeeeeeeeeeeeeeeeeeeeekpPk..",
    "..kPpkeeeeeeeeeeeeeeeeeeeekpPk..",
    "..kPpkeeeeeleeeleellleeeeekpPk..",
    "..kPpkeeeeeleeeleeeleeeeeekpPk..",
    "..kPpkeeeeeleeeleeeleeeeeekpPk..",
    "..kPpkeeeeeleeeleeeleeeeeekpPk..",
    "..kPpkeeeeeellleeellleeeeekpPk..",
    "..kPpkeeeeeeeeeeeeeeeeeeeekpPk..",
    "..kPpkeeeeeeeeeeeeeeeeeeeekpPk..",
    "..kPpkkkkkkkkkkkkkkkkkkkkkkpPk..",
    "..kPppppppppppppppppppppppppPk..",
    "..kPppppppppppppppppppppppppPk..",
    "..kPpppppdddppppppppppppppppPk..",
    "..kPpppppdddppppppppppppdddpPk..",
    "..kPpppdddddddppppppppppdddpPk..",
    "..kPpppdddddddppppppdddpdddpPk..",
    "..kPpppppdddppppppppdddpppppPk..",
    "..kPpppppdddppppppppdddpppppPk..",
    "..kPppppppppppppppppppppppppPk..",
    "..kPppppppppppppppppppppppppPk..",
    "..kPppppppppddddpddddpppppppPk..",
    "..kPppppppppppppppppppppppppPk..",
    "..kPppppppppppppppppppppppppPk..",
    "..kPPPPPPPPPPPPPPPPPPPPPPPPPPk..",
    "..kkkkkkkkkkkkkkkkkkkkkkkkkkkk..",
...
GEN1_WILD_QOL_NIGHTLY = (
    ...
    "..kPpkeeeeeeeeeeeeeeeeeeeekpPk..",
    "..kPpkeeeeeeeeeeeeeeeeeeeekpPk..",
    "..kPpkeeellleeellleeleeeeekpPk..",
    "..kPpkeeleeeleleeeleleeeeekpPk..",
    "..kPpkeeleeeleleeeleleeeeekpPk..",
    "..kPpkeeleeleeleeeleleeeeekpPk..",
    "..kPpkeeelleleellleelllleekpPk..",
    "..kPpkeeeeeeeeeeeeeeeeeeeekpPk..",
    "..kPpkeeeeeeeeeeeeeeeeeeeekpPk..",
    "..kPpkkkkkkkkkkkkkkkkkkkkkkpPk..",
    "..kPppppppppppppppppppppppppPk..",
...
# and four rows ticked off, drawn at the same size as the two handhelds.
GEN1_BENCH_NIGHTLY = (
    "................................",
    "............kkkkkkkk............",
    "............klPPPPlk............",
    "..kkkkkkkkkkklPPPPlkkkkkkkkkkk..",
    "..kpppppppppkkkkkkkkpppppppppk..",
    "..kpkkkkkkkkkkkkkkkkkkkkkkkkpk..",
    "..kpkddddddddddddddddddddddkpk..",
    "..kpkddddddddddddddddddddddkpk..",
    "..kpkdddddmddddddddddddddddkpk..",
    "..kpkddddmddlllllllllllllldkpk..",
    "..kpkdmdmdddlllllllllllllldkpk..",
    "..kpkddmdddddddddddddddddddkpk..",
    "..kpkddddddddddddddddddddddkpk..",
    "..kpkdddddmddddddddddddddddkpk..",
    "..kpkddddmddlllllllllllllldkpk..",
    "..kpkdmdmdddlllllllllllllldkpk..",
